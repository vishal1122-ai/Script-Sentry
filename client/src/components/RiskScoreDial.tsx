...
export default function RiskScoreDial({ score }: RiskScoreDialProps) {
  ...
  return (
    <Card className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow duration-300">
      <h3 className="text-xl font-legal font-semibold text-slate-800 mb-4 text-center">Risk Assessment</h3>
      ...
      <div className="relative w-44 h-44 mx-auto mb-4">
        <svg className="w-full h-full transform -rotate-90" viewBox="0 0 100 100">
          ...
          <circle 
            ...
            style={{
              filter: `drop-shadow(0 0 4px ${riskInfo.stroke}40)`
            }}
          />
        </svg>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            <div className="text-4xl font-bold mb-1" style={{ color: riskInfo.stroke }}>
              {score}
            </div>
